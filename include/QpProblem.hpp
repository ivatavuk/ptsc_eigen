...
struct DenseQpProblem {
  ...
  DenseQpProblem(	Eigen::MatrixXd t_A_qp, Eigen::VectorXd t_b_qp, 
                  Eigen::MatrixXd t_A_eq, Eigen::VectorXd t_b_eq,
...
struct SparseQpProblem {
  ...
  Eigen::VectorXd b_qp, b_eq, b_ieq, upper_bound, lower_bound;
  SparseQpProblem(Eigen::SparseMatrix<double> t_A_qp, Eigen::VectorXd t_b_qp, 
                  Eigen::SparseMatrix<double> t_A_eq, Eigen::VectorXd t_b_eq,
                  Eigen::SparseMatrix<double> t_A_ieq, Eigen::VectorXd t_b_ieq) 
    : A_qp(t_A_qp), A_eq(t_A_eq), A_ieq(t_A_ieq), 
      b_qp(t_b_qp), b_eq(t_b_eq), b_ieq(t_b_ieq) {};
  SparseQpProblem(Eigen::SparseMatrix<double> t_A_qp, Eigen::VectorXd t_b_qp, 
                  Eigen::SparseMatrix<double> t_A_eq, Eigen::VectorXd t_b_eq,
