...
public:
   ...
   */
  PTSC(const std::vector<Task>& tasks, const OsqpSettings& osqp_settings = OsqpSettings());
   ...
   * @param osqp_settings OsqpSettings object
   */
  PTSC(const std::vector<Task>& tasks, const Eigen::VectorXd& lower_bounds, const Eigen::VectorXd& upper_bounds,
   ...
   * @param osqp_settings OsqpSettings object
   */
  PTSC(const std::vector<Task>& tasks, const Eigen::MatrixXd& A_eq, const Eigen::VectorXd& b_eq,
       const Eigen::MatrixXd& A_ieq, const Eigen::VectorXd& b_ieq, const Eigen::VectorXd& lower_bounds,
       const Eigen::VectorXd& upper_bounds, const OsqpSettings& osqp_settings = OsqpSettings());
